                ...
                <View style={{ flex: 0.9 }}>
                    <ScrollView>
                        <View>
                            ...
                            <View style={{ height: Dimensions.get('window').height / 3, width: Dimensions.get('window').width, alignItems: 'center', justifyContent: 'center' }}>
                                <Image
                                    source={{ uri: 'https://romegamart.com/third-party/confirm.png' }}
                                    // source={require('../../assets/confirm.png')} 
                                    style={{ height: Dimensions.get('window').height / 7, width: Dimensions.get('window').width / 4 }} />
                            ...
                            <View style={{ marginLeft: 20, marginRight: 20 }}>
                                <Text style={{ fontSize: 16, lineHeight: 24 }}>
                                    Hello! Your item will be delivered to you in 7-10 days. Thank you for chossing our product
                                </Text>
                                <Text style={{ fontSize: 16, lineHeight: 24 }}>
                                    Keep Shopping
                                </Text>
                            ...
                            <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: Dimensions.get('window').height / 50, marginBottom: 40 }}>
                                <TouchableOpacity
                                    style={{ height: Dimensions.get('window').height / 15, width: Dimensions.get('window').width - 60, backgroundColor: '#00008b', borderRadius: 8, alignItems: 'center', justifyContent: 'center', marginTop: Dimensions.get('window').height / 5 }}
                                    onPress={() => this.props.navigation.navigate('Orders')}
                                >
