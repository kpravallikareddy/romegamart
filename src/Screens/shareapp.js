    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <View style={{ flex: 0.9 }}>
                    <ScrollView>
                        <View style={{ margin: 20, justifyContent: 'center', height: Dimensions.get('window').height / 8 }}>
                            <View style={{ flexDirection: 'row', }}>
                                <Image 
                                source={{uri: 'https://romegamart.com/third-party/share.png'}}
                                // source={require('../../assets/share.png')} 
                                style={{ height: Dimensions.get('window').height / 12 - 10, width: Dimensions.get('window').width / 9, marginTop: 3 }} />
                        ...
                        <View style={{ marginTop: Dimensions.get('window').height / 2, alignItems: 'center', justifyContent: 'center',marginBottom:40 }}>
                    <TouchableOpacity
                    ...
                    >
                        ...
                        {/* <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: Dimensions.get('window').height / 9 }}>
                            <View style={{ height: Dimensions.get('window').height / 2, width: Dimensions.get('window').width - 10, backgroundColor: 'rgba(211,211,211,1)', alignItems: 'center', justifyContent: 'center' }}>

                                <View style={{ height: Dimensions.get('window').height / 2 - 10, width: Dimensions.get('window').width - 10, backgroundColor: '#ffffff', borderTopLeftRadius: 25, borderTopRightRadius: 25, marginTop: 10 }}>
                                    <Swiper
                                        style={{ height: Dimensions.get('window').height / 2 - 50 }}
                                        horizontal={true}
                                        showsPagination={true}
                                        dot={<View style={{ backgroundColor: 'rgba(0,0,0,0.2)', width: 8, height: 8, borderRadius: 4, marginLeft: 3, marginRight: 3, marginBottom: 3 }} />}
                                        activeDot={<View style={{ backgroundColor: '#00bfff', width: 8, height: 8, borderRadius: 4, marginLeft: 3, marginRight: 3, marginBottom: 3, }} />}
                                    >
                                        <View>
                                            <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
                                                <View>
                                                    <Image source={require('../../assets/shareme.png')} style={{ height: 50, width: 50, }} />
                                                ...
                                                <View>
                                                    <Image source={require('../../assets/wb.png')} style={{ height: 50, width: 50, }} />
                                                    <Text style={{ fontSize: 16 }}>
                                                        WhatsApp
                                                    </Text>
                                                    <Text style={{ fontSize: 16 }}>
                                                ...
                                                <View>
                                                    <Image source={require('../../assets/insta.jpeg')} style={{ height: 50, width: 50, }} />
                                                    <Text style={{ fontSize: 16 }}>
                                                        Direct
                                                    </Text>
                                                </View>
                                                ...
                                                <View>
                                                    <MaterialCommunityIcons name="content-copy" size={50} color="rgba(211,211,211,1)" />
                                                    <Text style={{ fontSize: 16 }}>
                                                        Copy to
                                                    </Text>
                                                    <Text style={{ fontSize: 16 }}>
                                            ...
                                            <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
                                                <View>
                                                    <Image source={require('../../assets/drive.png')} style={{ height: 50, width: 50, }} />
                                                    <Text style={{ fontSize: 16 }}>
                                                        Save to Drive
                                                    </Text>
                                                </View>
                                                ...
                                                <View>
                                                    <FontAwesome name="telegram" size={50} color="#00bfff" />
                                                    <Text style={{ fontSize: 16 }}>
                                                        Telegram
                                                    </Text>
                                                </View>
                                                ...
                                                <View>
                                                    <MaterialCommunityIcons name="phone" size={50} color="#1e90ff" />
                                                    <Text style={{ fontSize: 16 }}>
                                                        Truecaller
                                                    </Text>
                                                </View>
                                                ...
                                                <View>
                                                    <Image source={require('../../assets/gmail.png')} style={{ height: 50, width: 50, }} />
                                                    <Text style={{ fontSize: 16 }}>
                                                        Gmail
                                                    </Text>
                                                </View>
                                    ...
                                    <View style={{ alignItems: 'center', justifyContent: 'center', marginBottom: 15 }}>
                                        <TouchableOpacity
                                            style={{ height: Dimensions.get('window').height / 13, width: Dimensions.get('window').width - 70, backgroundColor: '#d3d3d3', borderRadius: 25, alignItems: 'center', justifyContent: 'center', }}
                                        >
